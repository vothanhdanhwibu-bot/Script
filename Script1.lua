...
ImageButton.Image = "http://www.roblox.com/asset/?id=114648469367997"
...
local Tabs = {
    ...
    Title = "Discord",
    Description = "Danh Community",
    Callback = function()
        setclipboard("Có cái con cặc")
    end
})
    ...
    Description = "Cat",
    Callback = function()
        setclipboard("https://www.youtube.com/@BOSS_子猫_VNG")
    end
})
